                                ...
                                if IsControlJustPressed(0, 51) and hasBag then
                                    QBCore.Functions.Progressbar("deliverbag", Lang:t("info.progressbar"), 2000, false, true, {
                                        ...
                                        if (amountOfBags - 1) == 0 then
                                            QBCore.Functions.TriggerCallback('sandygarbage:server:NextStop', function(hasMoreStops, nextStop, newBagAmount)
...
RegisterNetEvent('sandygarbage:client:SetWaypointHome', function()
                ...
                if distance < 1.5 then
                    if InVehicle then
                        ...
                        if IsControlJustReleased(0, 38) then
                            QBCore.Functions.TriggerCallback('sandygarbage:server:EndShift', function(endShift)
                                if endShift then
                                    BringBackCar()
                        ...
                        if IsControlJustReleased(0, 38) then
                            QBCore.Functions.TriggerCallback('sandygarbage:server:NewShift', function(shouldContinue, firstStop, totalBags)
                                if shouldContinue then

                                    local coords = Config.Locations["vehicle"].coords
                                    QBCore.Functions.SpawnVehicle("scrap", function(veh)
                                        ...
                                        exports['YOURFUELHERE']:SetFuel(veh, 100.0)
            ...
            if payDistance < 20 then
                ...
                if payDistance < 1.5 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        TriggerServerEvent('sandygarbage:server:PayShift')
                    end
