...
QBCore.Functions.CreateCallback("sandygarbage:server:NewShift", function(source, cb)
...
QBCore.Functions.CreateCallback("sandygarbage:server:NextStop", function(source, cb, currentStop, currentStopNum, currLocation)
    local Player = QBCore.Functions.GetPlayer(source)
    local CitizenId = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('sandygarbage:server:EndShift', function(source, cb, location)
    local Player = QBCore.Functions.GetPlayer(source)
    local CitizenId = Player.PlayerData.citizenid
...
RegisterNetEvent('sandygarbage:server:PayShift', function()
    local src = source
